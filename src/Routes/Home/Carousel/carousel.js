...
import CircleButton from '../../../Components/loadingCircleButton/loadingCircleButton'
...
import bg0 from '../../../assets/images/s1.jpg'
import bg1 from '../../../assets/images/s2.jpg'
import bg2 from '../../../assets/images/s3.jpg'
import bg3 from '../../../assets/images/s4.jpg'
import bg4 from '../../../assets/images/s5.jpg'
import bg5 from '../../../assets/images/s6.jpg'
            ...
            <div className={styles.carousel_wrapper}>
                <div className={styles.carousel_bg_and_controls}>
                    ...
                    <div ref="outer0" className={`lead ${this.props.shrinked ? "shrinkedLeadWrapper" : ""}`} style={{zIndex: "10"}}>
                        <div ref="inner0" className={styles.container} style={{transform: "translateY(0%)", backgroundColor: "#6E00FF"}}>
                            <Lead
                                bgc="#6E00FF"
                                textColor="#FFF"
                                caption="Digital? \n That's what we do."
                                ...
                                buttonHref="/works"
                                customButtonStyle={styles.landingButton}
                            />
                    ...
                    <div ref="outer1" className={`lead ${this.props.shrinked ? "shrinkedLeadWrapper" : ""}`} style={{zIndex: "9"}}>
                        <div ref="inner1" className={styles.container} style={{transform: "translateY(10%)"}}>
                            <Lead
                                bgc="#29222F"
                                textColor="#FFF"
                                caption="Lufthansa Systems \n Product design"
                                subcaption="Strong advertising & media agency background with 15+ years of experience"
                                buttonText="Read case study"
                                buttonHref="/works"
                                customButtonStyle={styles.lufthansaButton}
                            />

                            {/*<Button text="Read case study" to="https://www.lufthansa.com/hu/en/homepage"/>*/}

                            {/*<img ref="hero1" className={styles.contentMedia} src={bg1} alt="hero1"/>*/}
                    ...
                    <div ref="outer2" className={`lead ${this.props.shrinked ? "shrinkedLeadWrapper" : ""}`} style={{zIndex: "8"}}>
                        <div ref="inner2" className={styles.container} style={{transform: "translateY(10%)"}}>
                            {/*<img ref="hero2" className={styles.contentMedia} src={bg2} alt="hero2"/>*/}
                            <Lead
                                bgc="#FCFCFC"
                                textColor="#000"
                                caption="Metalobox \n Redesign"
                                subcaption="Brand identity, UX/UI redesign, web development"
                                buttonText="Read case study"
                                buttonHref="/works"
                                customButtonStyle={styles.purpleButton}
                            />
                    ...
                    <div ref="outer5" className={`lead ${this.props.shrinked ? "shrinkedLeadWrapper" : ""}`} style={{zIndex: "5"}}>
                        <div ref="inner5" className={styles.container} style={{transform: "translateY(10%)"}}>
                            <img ref="hero5" className={styles.contentMedia} src={bg5} alt="hero5"/>
